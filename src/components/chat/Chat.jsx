  ...
  const tokenProvider = async (selectedUsername, isModerator, avatarUrl) => {
    ...
    try {
      const response = await axios.post(
        `${config.API_URL}createchattoken`,
        data,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization:
              "JWT eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImlzQWRtaW4iOnRydWUsImV4cCI6MTY5MDUyNzIzOCwiaWF0IjoxNjkwNTI1NDM4fQ.j5FxUrLE213Kh_V7Tn9WWGvPTyqv2B_dE7XsclTKQd7-vIww1Y5y14dNmGt6CBpTSmRSb5v9vWhBQw0fnTyDoQ",
          },
        }
      );
          ...
          <div className="col-wrapper">
            <div className="chat-wrapper">
              ...
              <div className="composer fl fl-j-center">
                ...
                {isChatConnected() && (
                  <SendMessage handleSend={handleKeySend} />
                )}
                {!username && (
                  <fieldset>
                    <button
